...
namespace GoogleContacts.Domain
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            List<GroupModel> groups = await GoogleContacts.GetGroups();
            ...
            //var model = (await GoogleContacts.GetContacts(personFields)).FirstOrDefault();
        ...
        public static class GoogleContacts
        {
            ...
            public static async Task<List<GroupModel>> GetGroups()
            {
                ...
                ListContactGroupsResponse response = await listRequest.ExecuteAsync();
            ...
            public static async Task<GroupModel> CreateGroup(GroupModel model)
            {
                ...
                ContactGroup response = await groupsResource.Create(request).ExecuteAsync();
            ...
            public static async Task<GroupModel> UpdateGroup(GroupModel model)
            {
                ...
                ContactGroup response = await groupsResource.Update(request, model.modelResourceName).ExecuteAsync();
                return new GroupModel(response);
            }
